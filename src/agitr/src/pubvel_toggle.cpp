//This program toggle between rotatation and translation
...
bool forward=true;
bool toggleForward(std_srvs::EmptyRequest &req, std_srvs::Empty::Response &resp){
    forward=!forward;
...
int main(int argc, char **argv){
    ...
    //publich commands, using the latest value for forward,
